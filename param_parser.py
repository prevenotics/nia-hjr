...
class TrainParser(BaseParams):
    def __init__(self):
        ...
        self.add_argument("--sampling_num", default=32, type=int, help="sampling_point(n x n) for train")
        self.add_argument("--batch_size", type=int, default=32, help="number of batch size")
        self.add_argument("--train_batch_size", default=32, type=int, help="train batch size")
        self.add_argument("--val_batch_size", default=32, type=int, help="validataion batch size")
        ...
        self.add_argument("--eval_freq", default=5, type=int, help="eval freq")                
