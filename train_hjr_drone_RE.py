...
#CUDA_VISIBLE_DEVICES=8,9,10,11,12,13,14,15 python -m torch.distributed.launch --nproc_per_node 8 --master_port 2334 train_hjr_drone_RE.py
...
#CUDA_VISIBLE_DEVICES=10,11,12,13,14,15 python -m torch.distributed.launch --nproc_per_node 6 --master_port 1234  train_hjr_drone_RE.py
...
if __name__ == '__main__':
    ...
    with open('cfg_train_drone_RE.yaml') as f:
