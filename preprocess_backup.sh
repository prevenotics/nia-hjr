...
/workspace/dataset/3.mat_drone
find '/workspace/dataset/3.mat_drone' -type f -regex '.*D.*\RE.mat$' >/workspace/dataset/total_mat_RE_drone.txt
find '/workspace/dataset/3.mat_drone' -type f -regex '.*D.*\RA.mat$' >/workspace/dataset/total_mat_RA_drone.txt