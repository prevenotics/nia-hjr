...
#CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node 8 --master_port 1234 train_hjr_drone_RA.py
...
#CUDA_VISIBLE_DEVICES=5,6,7,8,9,10 python -m torch.distributed.launch --nproc_per_node 6 --master_port 1234  train_hjr_drone_RA.py
#CUDA_VISIBLE_DEVICES=5,6,7,8,9,10 python -m torch.distributed.launch --nproc_per_node 6 --master_port 1234  train_hjr_drone_RA.py
...
if __name__ == '__main__':
    ...
    with open('cfg_train_drone_RA.yaml') as f:
